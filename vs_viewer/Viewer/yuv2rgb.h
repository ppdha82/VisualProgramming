...
typedef void (* yuv2rgb_fun) (uint_8 * image, const uint_8 * py,
...
typedef void (*conv_i420_2vuy_fun) (
    uint_8 *image, int vuy_stride,
    const uint_8 *py, const uint_8 *pu, const uint_8 *pv,
...
typedef void (*conv_2vuy_i420_fun) (
    uint_8 *py, uint_8 *pu, uint_8 *pv,
    int y_stride, int u_stride, int v_stride,
    const uint_8 *image, int vuy_stride,
    int h_size, int v_size);
